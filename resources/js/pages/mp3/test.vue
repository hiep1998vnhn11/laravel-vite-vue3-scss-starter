                ...
                <div class="cover" :class="{ 'is-playing': isPlaying }">
                    ...
                    <div class="overlay" :class="{ 'is-playing': isPlaying }">
                        <div class="center">
                            <button
                                class="btn border"
                                @click.stop="playPlaylist(album, true)"
                            >
                                <i
                                    class="icon"
                                    :class="
...
<script lang="ts">
import SongInline from '/@/components/Mp3/song/Inline.vue'
import { useRoute, useRouter } from 'vue-router'
import { fetchPlaylist } from '/@/api/mp3'
...
export default defineComponent({
    ...
    setup() {
        ...
        const isCurrent = computed(
            () => player.currentPlaylistId.value === album.value.encodeId
        )
